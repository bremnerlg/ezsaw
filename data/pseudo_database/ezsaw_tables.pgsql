...
CREATE TYPE door_t AS ENUM ('driver_front', 'driver_rear', 'passenger_front', 'passenger_rear', 'trunk/hatch', 'hood');
...
INSERT INTO steps (vin, door, auto_door_stat) VALUES
...
('5UXKR0C58F0123456',  'trunk/hatch',      53),
('5UXKR0C58F0123456',  'hood',             54),
('1GNSK2E04ER123456',  'trunk/hatch',      55),
('1GNSK2E04ER123456',  'hood',             56),
('JTEBU5JR4F5234567',  'trunk/hatch',      57),
('JTEBU5JR4F5234567',  'hood',             58),
('5TDBKRFH9FS234567',  'trunk/hatch',      59),
